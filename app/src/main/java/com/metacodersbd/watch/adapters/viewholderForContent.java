...
public class viewholderForContent  extends RecyclerView.ViewHolder {
    ...
    public viewholderForContent(@NonNull View itemView) {
        super(itemView);
    ...
    private  static  viewholderForContent.ClickListener  mClickListener;
    ...
    public  static String setOnClickListener(ClickListener clickListener)
    {
